...
//    U glavnom programu kreirati video plejer i izvrsiti neke akcije nad njim.
    public static void main(String[] args) {
        ...
        VideoPlayer player = new VideoPlayer(60.0, 42.0, 10.0, 460);
        System.out.println(player.getTrenutnoVreme());

        TimeControl control = new TimeControl(true);
        control.izvrsiAkciju(player);
        System.out.println(player.getTrenutnoVreme());
