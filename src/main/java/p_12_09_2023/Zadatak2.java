...
//    U glavnom programu kreirati objekte definisanih klasa i testirati rad definisanih funkcija
    ...
    public static void main(String[] args) {
        Korisnik korisnikHost = new Korisnik("Marko Markovic");
        Korisnik korisnikGuest = new Korisnik("Sima Simic");
        korisnikHost.pretplatiSe(100);
        korisnikGuest.stampaj();

     korisnikGuest.pretplatiSe(150);
     korisnikGuest.ponistiPretplatu();

     ZoomCall zoomCall = new ZoomCall("http:zosng.com/1hr4yc3e", "1sisgb3345", korisnikHost);
     zoomCall.setGuest(korisnikGuest);
     zoomCall.stampaj();
