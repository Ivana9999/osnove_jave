...
//    u main funkciji, napraviti visa i master kartice i testirati funkcije
    ...
    public static void main(String[] args) {
      VisaKartica visa = new VisaKartica(2103.0, "03485-54345", 2023, 8, "Marko Markovic");
     MasterKartica master = new MasterKartica(9320.5, "9347-2948", 2024, 3);

      visa.izvrsiTransakciju(100);
      master.izvrsiTransakciju(50);
