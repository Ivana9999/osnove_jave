...
//    Notifikacija: Nova verzija aplikacije je dostupna za instalaciju.
    public static void main(String[] args) {
        ...
        System.out.println("Na racnunaru je instalirana verzija: " + major + "." + minor);
        ...
        System.out.println("Najnovija verzija je: " + majorNajnovijaVerzija + "." + minorNajnovijaVerzija);

        if (major >= majorNajnovijaVerzija && minor >= minorNajnovijaVerzija) {
            System.out.println("Notifikacija: Vec imate najnoviju verziju na svom racunaru.");

        } else {
            System.out.println("Notifikacija: Nova verzija aplikacije je dostpna za instalaciju.");
        }
    }
}
